...
class SimpleArc:
    ...
    def calc(self, xcenter, ycenter, radius, startangle, endangle):
        ...
        block.append(globCNC.grapid(x=xstart, y=ystart))
        ...
        if startangle < endangle:
            ...
            direction = 2
        block.append(globCNC.garc(direction, x=xend, y=yend, i=i, j=j))
...
class Tool(Plugin):
    ...
    def execute(self, app):
        ...
        if active == 0:
            active = 1
        globGCode.insBlocks(active, blocks, _("Create Simple Arc"))
        app.refresh()
