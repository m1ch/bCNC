# Marlin motion controller plugin

# FIRMWARE_NAME:Marlin bugfix-2.1.x (Jul  6 2022 17:17:05) SOURCE_CODE_URL:github.com/MarlinFirmware/Marlin PROTOCOL_VERSION:1.0 MACHINE_TYPE:CNC-3018 EXTRUDER_COUNT:1 UUID:cede2a2f-41a2-4748-9b12-c55c62f367ff
...
# Cap:MEATPACK:0
# Cap:CONFIG_EXPORT:0
# area:{full:{min:{x:0.00,y:0.00,z:0.00},max:{x:290.00,y:180.00,z:29.00}},work:{min:{x:0.00,y:0.00,z:0.00},max:{x:290.00,y:180.00,z:29.00}}}
